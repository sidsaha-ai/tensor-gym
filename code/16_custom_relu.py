...
class CustomReLUFn(torch.autograd.Function):  # pylint: disable=abstract-method
    """
    ...
    @staticmethod
    def backward(ctx, grad_output: torch.Tensor) -> torch.Tensor:  # pylint: disable=arguments-differ
        """
